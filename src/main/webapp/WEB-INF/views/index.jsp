...
<div class="banner supported-by">
    <ul class="supported-list">
        <li>
            <a href="#">
                <img src="/assets/img/supported_by/logo_magicecole.png" width="200" height="100">
            </a>
            <a href="#">
                <img src="/assets/img/supported_by/og.png" width="200" height="100">
            </a>
            <a href="#">
                <img src="/assets/img/supported_by/down.png" width="200" height="100">
            </a>
        </li>
    </ul>
</div>
