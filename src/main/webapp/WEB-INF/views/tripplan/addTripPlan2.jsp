        ...
        <div class="row">
          ...
          <div class="col-sm-5">
            ...
            <div style="text-align: center;">
              ...
              <div id="menu_wrap0"></div>
                <div class="box-title">
                    <div class="input-group">
                      <input type="text" class="form-control" id="placeName0" onkeypress="handleKeyPress(event, 0)" placeholder="명소 검색">
                      <div class="input-group-btn">
                        <button class="btn btn-primary" id="placeSearch0" onclick="handleKeyPress(event, 0)">Search</button>
                      </div>
                    </div>
                </div>
              ...
              <div class="border-box">
                <div class="box-title">명소리스트 <div class="tag-link" style="text-align: right;" id="totalTripTime0"></div></div>
                <ul class="list0">
  ...
  <script type="text/javascript">
    ...
    function initializeSummernote(idCheck) {
      $('#dailyPlanContents' + idCheck).summernote({
        ...
        focus: true,
        lang: "ko-KR",
        placeholder: (idCheck+1) + "일차 여행블랜 본문"
      });
    }
