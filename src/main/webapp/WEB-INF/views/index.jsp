...
<main>
    ...
    <div id="carousel" class="carousel slide carousel-fade full-height stick-top">
        ...
        <button class="carousel-control-next bottom-right" type="button" data-bs-target="#carousel" data-bs-slide="next">
