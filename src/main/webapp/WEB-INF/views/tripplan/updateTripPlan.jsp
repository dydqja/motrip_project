    ...
    <div style="display: flex; justify-content: space-between;">
        <div class="plan-contents">
            <div class="map_wrap" style="display: flex;">
                <textarea id="dailyPlanContents${i-1}"
                          style="width: 300px; height: 400px; resize: vertical; overflow: auto;">${dailyPlan.dailyPlanContents}</textarea>
                <div id="menu_wrap${i-1}">
                    <div class="option">
                        <input type="text" id="placeName${i-1}" placeholder="장소 검색"
                               onkeypress="handleKeyPress(event, ${i-1})">
                        ...
                        <tr>
                            ...
                            <div class="col-12 column">
                                ...
                                <div class="card text-white mb-3 " style="background-color: rgb(76, 94, 153);">
                                    <div class="card-header" name="placeCategory" id="${i-1}"
                                         data-index="${varStatus.index}">${place.placeCategory}
                                        <label class="deleteBox" name="deleteBox" id="${i-1}"
                                ...
                                <div class="card text-white mb-3 " name="tripTime" id="${i-1}"
                                     data-index="${varStatus.index}" style="background-color: rgb(200, 94, 153);">
                                        ${place.tripTime}
                                </div>
                            </div>
                        </tr>
